...
export function BotFlowEditor({ rule, onSave, onStatusChange }: BotFlowEditorProps) {
  ...
  return <div className="space-y-3" onClick={() => { if (menuNodeId) setMenuNodeId(null); }}>
    ...
    <div className={cn("grid min-h-[44rem] gap-3", catalogOpen && inspectorOpen ? "lg:grid-cols-[17rem_minmax(0,1fr)_20rem]" : catalogOpen ? "lg:grid-cols-[17rem_minmax(0,1fr)]" : inspectorOpen ? "lg:grid-cols-[minmax(0,1fr)_20rem]" : "lg:grid-cols-1")}>
