  ...
  return (
    <div data-bio-socials className={cn("flex gap-2 justify-center", className)}>
      {config.socials.map((s) => {
        ...
        return (
          <a key={s.platform + s.url} href={safeUrl(s.url)} target="_blank" rel="noreferrer noopener"
    ...
    <div className="min-h-full px-4 py-5">
      ...
      <div className="mt-4 flex gap-3 overflow-x-auto pb-2 -mx-4 px-4">
        {links.slice(0, 6).map((l, i) => (
          <a key={l.id} href={safeUrl(l.url)} data-bio-btn target="_blank" rel="noreferrer noopener" className="flex flex-col items-center gap-1 shrink-0">
